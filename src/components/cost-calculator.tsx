...
export default function CostCalculator() {
  ...
  return (
    <div className="p-6 rounded-2xl bg-white dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 shadow-sm space-y-6">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs font-bold px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/50">
          Pro Feature
        </span>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-xs font-semibold">
          <span className="text-slate-600 dark:text-slate-400">Usuarios Activos Estimados:</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
        <div className="p-3.5 rounded-xl bg-slate-100/70 dark:bg-slate-800/50 border border-slate-200/60 dark:border-slate-800 space-y-1">
          <div className="flex items-center text-xs font-medium text-slate-600 dark:text-slate-400 space-x-1.5">
            <Server className="w-3.5 h-3.5 text-slate-900 dark:text-white" />
      ...
      <div className="p-4 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white flex items-center justify-between shadow-md shadow-indigo-500/20">
        <div className="flex items-center space-x-2">
          <Zap className="w-5 h-5 fill-current text-amber-300" />
          <span className="text-xs font-semibold">Coste de Operación Estimado:</span>
        </div>
